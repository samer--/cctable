...
in \secrf{conclusions} and supplementart code in the appendices.

[Contribution? Differences from previous methods?]
...
variant classess without resorting to extra-logical operations
...
to acheive a complete factorisation of the state of
...
using non-backtrackable global variables to carry badly factorised state.
...
most obviously in Fibonacci benchmark, where the total size
...
as in \secrf{complexity} in terms of the number of producers, consumers and solutions, as follows:
\begin{center}
...
did not complete within the allowed time of 240 s. \tablab{timings}}
\end{table}
...
developed here is quite competetive, running about half as fast in most benchmarks. Although
...
version decribed by \cite{Abdallah2017a}, but they share many similarities with
...
and greater code simplicy and declarativeness.
