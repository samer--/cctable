...
and expressed as a unary predicate by using a lambda term "\X^Cont" (see the supporting
...
newly captured continuation, in the form of a two-argument lambda term "Ky", is added to the 
...
\begin{figure}
  \begin{center}
    ...
    \begin{tabular}{@{}c@{\hspace{-2em}}c@{}}
      \colfig[0.58]{figs/fib(1000)}
    & \colfig[0.58]{figs/nrev(1000)}
    \\
      \colfig[0.58]{figs/test_joins}
    & \colfig[0.58]{figs/ping_pong(10000)}
    \\
      \colfig[0.58]{figs/recognise(20000)}
    & \colfig[0.58]{figs/monoidal}
  \end{tabular}
  \end{center}
